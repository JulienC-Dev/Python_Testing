...
def test_purchase_places_valid_balance_point_club(client, name, name_competion, point_club):
...
def test_purchase_place_withdraw_competition_points(client, name, name_competion, points_competion):
    input_places_desire = "2"
    ...
    # print(points_competion)
    # print(data)
    # expected_output_points_competiion = 23
    # assert f'Number of Places: 21' in data
